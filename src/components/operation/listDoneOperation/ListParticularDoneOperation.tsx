'use client'
import styles from './ListParticularDoneOperation.module.css';
...
export default function ListParticularDoneOperation(props:{operationType:string, operation:GetOperationResponseDto[]|null}) {
